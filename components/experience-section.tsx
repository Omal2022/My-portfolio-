...
import { Trophy, Globe, CheckCircle, ExternalLink, Calendar, MapPin } from 'lucide-react';
  ...
  const experiences = [
    {
      ...
      description: 'Built a solution during the hackathon that solved a real-world problem through collaborative teamwork.',
      details: [
        'Created a scalable product MVP in limited time',
        'Collaborated with cross-functional team members',
        'Implemented innovative problem-solving approaches',
        'Secured 2nd place among competitive participants'
      ],
  ...
  const projects = [
    {
      ...
      description: 'A modern security services platform showcasing security professionals with responsive design.',
    ...
    },
    {
      ...
      description: 'A beautiful, feature-rich todo application with smart filtering and glassmorphism design.',
      url: 'https://todoapp-lake-seven.vercel.app',
      tech: ['React 18', 'TypeScript', 'Tailwind CSS', 'shadcn/ui', 'Lucide React', 'Vite'],
      features: [
    ...
    {
      title: 'AI Notepad',
      description: 'A smart note-taking application with AI-assisted features for enhanced productivity.',
      url: '#',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          {experiences.map((exp, index) => (
            <Card key={index} className="bg-card/50 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all duration-300">
              <CardHeader>
